 ...
 *
 */
public class FindCommentJFrame extends JFrame  implements ActionListener,ItemListener{
...
public void bindDayData(){
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("查询")) {
			...
			if (where!=null) {
	          CommentJtable commentJtable=new CommentJtable(where.toString());
		}

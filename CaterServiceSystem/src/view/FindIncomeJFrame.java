 ...
 *
 */
public class FindIncomeJFrame extends JFrame implements ActionListener,ItemListener {
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("查询")) {
			...
			if (index3 > 0) {
	            ...
	            CreatePieChart3DView chart3dView=new CreatePieChart3DView(where.toString());
	            }
	            if(jComboBox3.getSelectedItem().equals("柱状图")){
	            	CreateColumnChartView chartView=new CreateColumnChartView(where.toString());
	            }
	            if(jComboBox3.getSelectedItem().equals("表格式")){
	            	FindIncome findIncome=new FindIncome(where.toString());
	            }
		}

 ...
 *
 */
public class FindPersonSaleJFrame extends JFrame implements ActionListener,ItemListener {
 ...
 private UserService userService=new UserService();
	...
	public FindPersonSaleJFrame() {
		this.setTitle("员工业绩详情查询服务");
	...
	public void actionPerformed(ActionEvent e) {
		...
		if (e.getActionCommand().equals("查询")) {
			...
			if(index<=0&&index1<=0&&index2<=0){
				where=null;
				JOptionPane.showMessageDialog(this, "年，月，日至少选择一项！");
			}
			if(index3<=0){
				JOptionPane.showMessageDialog(this, "请选择员工！");
			}
			if (index3 > 0 &&where!=null) {
	            if(!jComboBox3.getSelectedItem().equals("--请选择员工--")){
	            	String name=jComboBox3.getSelectedItem().toString();
	           PersonSaleJtable chart3dView=new PersonSaleJtable(where.toString(),name);
	            }
